      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            <p className="text-muted-foreground text-sm">
              Decentralized collaboration platform for seamless peer-to-peer connections.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/demo" className="text-muted-foreground hover:text-foreground text-sm">Try Demo</Link></li>
              <li><Link to="/roadmap" className="text-muted-foreground hover:text-foreground text-sm">Roadmap</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/team" className="text-muted-foreground hover:text-foreground text-sm">Team</Link></li>
        ...
        <div className="border-t border-border mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} PeerLink. All rights reserved.
          </p>
